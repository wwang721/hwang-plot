...
models = ['NH3N-NAIVE', 'NH3N-RIDGE', 'NH3N-WEIGHTED', 'NH3N-LSTM', 'NH3N-TCAN']
model_labels = {
    'NH3N-NAIVE':    'Naive Baseline',
    'NH3N-RIDGE':    'Ridge Regression',
    'NH3N-WEIGHTED': 'Weighted Average',
    'NH3N-LSTM':     'LSTM',
    'NH3N-TCAN':     'TCAN-Attention',
}
...
for model in models:
    ...
    plt.savefig(f"figs/6_{model}.png", dpi=300, bbox_inches='tight')
    plt.close(fig)
