...
# SHAP-style colormap: blue → pink-red, no white centre (for beeswarm)
shap_cmap = mcolors.LinearSegmentedColormap.from_list(
    'shap', ['#1E88E5', '#FF0D57']
)
# SHAP-style diverging colormap: blue → white → pink-red (for heatmaps)
shap_div_cmap = mcolors.LinearSegmentedColormap.from_list(
    'shap_div', ['#1E88E5', '#FFFFFF', '#FF0D57']
)

available = {f.name for f in fm.fontManager.ttflist}
fonts = ["Times New Roman", "Noto Sans CJK JP"]
fonts = [f for f in fonts if f in available]
